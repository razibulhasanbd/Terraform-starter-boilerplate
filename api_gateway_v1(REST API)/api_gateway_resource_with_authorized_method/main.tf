...
resource "aws_api_gateway_resource" "api_gateway_resource" {
  ...
  path_part   = "api-path"  # need to configure as your api endpoint
}
...
resource "aws_lambda_permission" "lambda_permission" {
  ...
  source_arn = "${var.api_gateway_source_arn}/*/GET/api-path" # need to configure as your api gateway method type and endpoint path
  depends_on = [
